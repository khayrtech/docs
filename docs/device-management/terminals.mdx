...
- **Stripe Reader M2**: Compact mobile card reader for flexible donation collection

The BBPOS WisePOS E is recommended for permanent donation stations, while the Stripe Reader M2 is ideal for mobile fundraising events or secondary collection points.

## Terminal Acquisition Process

To obtain payment terminals for your organization:

1. Sign in to your Stripe Dashboard at [dashboard.stripe.com](https://dashboard.stripe.com)
2. Navigate to "Terminal" and then select "Readers"
3. Click "Order readers" and select your preferred model
4. Specify the quantity needed for your organization
5. Complete the shipping and payment information
6. Allow 5-7 business days for delivery

Alternatively, contact [support@khayr.tech](mailto:support@khayr.tech) for assistance with hardware acquisition through Khayr Technologies.
...
| Not connected | Terminal has not been detected within the past 60 minutes |
...
For a complete donation station, pair your payment terminal with a kiosk display:

### Kiosk Integration Benefits

- Larger interface for project selection and donation amount choices
- Enhanced visual presentation of fundraising initiatives
- Improved donor guidance through the contribution process
- Seamless handoff between donation selection and payment processing

To create an integrated donation station, follow the [kiosk setup instructions](/docs/device-management/kiosks) and associate it with your payment terminal.

## Terminal Management Functions

The dashboard provides several terminal management capabilities:

### Remote Terminal Control

- View terminal status and connection information
- Restart terminals remotely when troubleshooting
- Update terminal software and security patches
- Lock terminals when not in use

### Transaction Monitoring

- View real-time transaction status
- Monitor terminal activity history
- Identify usage patterns and peak donation times
...
- Store terminals in secure locations when not in use
- Enable terminal lock codes for additional protection
- Regularly inspect terminals for signs of tampering
- Maintain an inventory of terminal devices with locations
